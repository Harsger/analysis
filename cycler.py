...
def main(argv):
    ...
    for i , name in enumerate(dataName):
        ...
        for p in dataPath :
            ...
            command += "/project/etp4/mherrmann/analysis/results/CRF/moduleThree/voltageScan/FECforBoard"
...
#python executor.py -W -L -c '/project/etp3/mherrmann/analysis/investigateCRF -o /project/etp4/mherrmann/analysis/results/CRF/ETA3/m3sep -p /project/etp3/mherrmann/analysis/parameterfiles/moduleThree/parameter_SM2-M3_CRF20180913.txt' -d /project/etpdaq4/mherrmann/fitteddata/moduleThree -i sm2_m3_560V_2018092
#/project/etp3/mherrmann/analysis/postprocessor -m precision -p /project/etp3/mherrmann/analysis/parameterfiles/moduleThree/parameter_SM2-M3_CRF20180913.txt -d /project/etp4/mherrmann/analysis/results/CRF/ETA3/m3sep -i m3sep.root
  
#python executor.py -W -L -c '/project/etp3/mherrmann/analysis/investigateCRF -o /project/etp4/mherrmann/analysis/results/CRF/ETA3/m6jan -p /project/etp3/mherrmann/analysis/parameterfiles/moduleSix/parameter_M6_eta3_CRF20181206.txt' -d /project/etpdaq4/mherrmann/fitteddata/moduleSix -i m6_5
#/project/etp3/mherrmann/analysis/postprocessor -m precision -p /project/etp3/mherrmann/analysis/parameterfiles/moduleSix/parameter_M6_eta3_CRF20181206.txt -d /project/etp4/mherrmann/analysis/results/CRF/ETA3/m6jan -i m6eta3jan.root

#python executor.py -W -L -c '/project/etp3/mherrmann/analysis/investigateCRF -o /project/etp4/mherrmann/analysis/results/CRF/ETA3/m8may -p /project/etp3/mherrmann/analysis/parameterfiles/m8/parameter_SM2nDoublet_20190523.txt' -d /project/etp4/mherrmann/fitteddata/m8 -i m8_eta3_8020
#/project/etp3/mherrmann/analysis/postprocessor -m precision -p /project/etp3/mherrmann/analysis/parameterfiles/m8/parameter_SM2nDoublet_20190523.txt -d /project/etp4/mherrmann/analysis/results/CRF/ETA3/m8may -i m8eta3_8020.root
